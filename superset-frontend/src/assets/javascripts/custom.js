...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const setupToggle = () => {
    ...
    console.log('gridRows',gridRows);
    console.log('toggleLink.dataset.toggleSetup',toggleLink.dataset.toggleSetup);
    ...
    if (gridRows.length >= 3 && toggleLink && !toggleLink.dataset.toggleSetup) {
      ...
      console.log('chartARow',chartARow);
      
      const chartBRow = gridRows[2];
      console.log('chartBRow',chartBRow);

      const dividerRow = gridRows[0];
      console.log('dividerRow',dividerRow);
      ...
      const hasChartA = chartARow.querySelector('[data-test="chart-id-205"]');
      const hasChartB = chartBRow.querySelector('[data-test="chart-id-208"]');
