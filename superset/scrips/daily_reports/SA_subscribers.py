...
def run_subscriber_extraction(config_file, log_filename, cust_name):
    ...
    try:
        ...
        WHERE report_type = 'Daily System Alert Report' 
        ...
        for row in results:
            ...
            for email in emails:
                try:
                    ...
                    subprocess.run(
                        ["python3", "/ebs/scrips/daily_reports/SA_endcustomer.py", email, bc2r_schema, extracts_schema, email_subject, cust_name],
                        check=True
                    )
